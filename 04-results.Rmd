...
```{r, model1, eval = F, fig.height = "778px", fig.asp = .618}
overall_stats_for_all_models[[2]] %>% 
...
```{r, spec-solutions-m1_3, cache = TRUE, eval = F}
...
```{r, spec-solutions-m1_4, cache = TRUE, eval = F}
...
extract_LL_mplus() %>%    knitr::kable()
```

```{r, spec-solutions-m1_5, cache = TRUE, eval = F}
...
```{r, spec-solutions-m1_6, cache = TRUE, eval = F}
...
```{r, spec-solutions-m1_7, cache = TRUE, eval = F}
...
```{r, spec-solutions-m1_7-other-LL, cache = TRUE, eval = F}
m1_7 <- estimate_profiles_mplus(df,  
                                dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence,
                                starts = c(600, 120),
                                model = 1,
...
```{r, spec-solutions-for-model2, cache = TRUE, eval = F}
...
```{r, spec-solutions-model2-4, cache = TRUE, eval = F}
...
```{r, spec-solutions-model2-5, cache = TRUE, eval = F}
...
```{r, spec-solutions-model2-6, cache = TRUE, eval = F}
...
```{r, spec-solutions-model2-7, cache = TRUE, eval = F}
