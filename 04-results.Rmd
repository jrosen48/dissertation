...
For the composite of work with data, the composite predicted profile 1 (B = 0.007 (0.004), p = .019), but not any of the other profiles. However, this coefficient is very small. 
...
When looking across findings, we find very few relations between work with data and the profiles. When looking across findings, we find very few relations between work with data and the profiles. 
...
When looking across findings, we find very few relations between work with data and the profiles. When looking across findings, like for research question #2, we find very few relations between work with data and the profiles. 
