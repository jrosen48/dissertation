...
Very often these are focused on solving equations, even when related to real-life (as in buying groecries, how money is spent, and how to budget, in *Comunidad de Apendizaje*). In these episodes during which youth were modeling data (4/68; 6%), they were using equations provided by the youth activity leader to solve problems
...
In sum, these findings show substantial variability in the profiles present at the youth level, with less explained by the program youth were in or the nature of the particular instructional episode present at the time youth were signaled. 
