...
overall_stats_for_all_models[[2]] %>% 
  ...
  select(-model, n_profile = n_profiles) %>% 
...
```{r, model1, eval = T, cache = F, fig.cap = "Fit statistics for model 1"}
...
```{r, model2, eval = T, cache = F, fig.cap = "Fit statistics for model 2"}
...
preferred to the others. All of the LRTs suggest that the more complex model be selected, not providing clear information about which solutions are to be preferred. On the basis of these pieces of evidence, models with 3, 4, and 5 solutions may be considered in more depth. However, there is a lack of consistent evidence favoring more or less complex models.
