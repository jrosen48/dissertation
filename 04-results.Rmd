...
Asking more general questions. The question was the one asking the question or defining the problem. 
...
A model was not always one of data. Sometimes, the model was a physical model, such as during the *Crazy Machines* program, in which youth saw how changes to their Rube Goldberg machine worked or did not work. 
