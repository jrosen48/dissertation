...
```{r, compare-solutions-all, eval = F}
...
```{r, new-chunk, eval = T}
# write_rds(d, "data/solutions-for-all-models.rds")

d <- read_rds("data/solutions-for-all-models.rds")

d %>% 
  knitr::kable(caption = "Solutions for all models", booktabs = TRUE)
```
...
```{r, new-chunk-model1, eval = T}
write_rds(d, "data/solutions-for-model-1.rds")

d <- read_rds("data/solutions-for-model-1.rds")

d %>% 
  knitr::kable(caption = "Solutions for model 1", booktabs = TRUE)
```

```{r, fig.cap = "Plot for model 1"}
d %>% 
