...
d1_na <- is.na(d1$`Qualitative Coding`)
d2_na <- is.na(d2$`Qualitative Coding`)
d3_na <- is.na(d3$`Qualitative Coding`)

d1i <- dplyr::pull(d1, `Qualitative Coding`)
d2i <- dplyr::pull(d2, `Qualitative Coding`)
d3i <- dplyr::pull(d3, `Qualitative Coding`)
