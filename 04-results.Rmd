...
```{r, spec-solutions-m1_3, cache = TRUE, eval = FALSE}
...
```{r, spec-solutions-m1_4, cache = TRUE, eval = FALSE}
...
```{r, spec-solutions-m1_5, cache = TRUE, eval = FALSE}
...
```{r, spec-solutions-m1_6, cache = TRUE, eval = FALSE}
...
```{r, spec-solutions-m1_6-alt, cache = TRUE, eval = FALSE}
...
```{r, spec-solutions-m1_7, cache = TRUE, eval = FALSE}
...
```{r, spec-solutions-m1_7-other-LL, cache = TRUE, eval = FALSE}
m1_7 <- estimate_profiles_mplus(df,  
                                dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence,
                                starts = c(600, 120),
                                model = 1,
...
```{r, spec-solutions-for-model2, cache = TRUE, eval = FALSE}
...
```{r, spec-solutions-model2-4, cache = TRUE, eval = FALSE}
...
```{r, spec-solutions-model2-5, cache = TRUE, eval = FALSE}
...
There is a wide range of profiles. Some appear very commonly, particularly those (full and universally low) characterized by high or low levels across all of the variables.
