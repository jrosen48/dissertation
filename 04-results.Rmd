...
Very often, in the (approximately) other half of episodes (51%) related to this aspect of work with data, the ways in which youth generated data were not very systematic or clearly identifiable. This code was present when youth point out the relations between points in a scatterplot figure (which the instructor then translated into an equation) during the *Uptown Architecture* program. In another instructional episode during the *Zoology Partners* program, this code was present as youth solved riddles while traveling on a bus to a community site. 
