---
title: "Comparing MPlus model solutions via tidyLPA"
...
#### Following up on all five variables: 
```{r, echo = T, message = T}
m2_4 <- estimate_profiles_mplus(df, 
                        dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence,
                        starts = c(600, 120),
                        model = 2, n_profiles=4,
                        n_processors = 8)

m2_5 <- estimate_profiles_mplus(df, 
                        dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence,
                        starts = c(600, 120),
                        model = 2, n_profiles=5,
                        n_processors = 8)

m2_6 <- estimate_profiles_mplus(df, 
                        dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence,
                        starts = c(600, 120),
                        model = 2, n_profiles=6,
                        n_processors = 8)

m2_7 <- estimate_profiles_mplus(df, 
                        dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence,
                        starts = c(600, 120),
                        model = 2, n_profiles=7,
                        n_processors = 8)

m2_8 <- estimate_profiles_mplus(df, 
                        dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence,
                        starts = c(600, 120),
                        model = 2, n_profiles=6,
                        n_processors = 8)
...
```{r, echo = T}
m2_4 %>% plot_profiles_mplus()
m2_5 %>% plot_profiles_mplus()
m2_6
m2_7 %>% plot_profiles_mplus()
m2_8
```
...
## 2. Just three (with composite of engagement)

```{r, 2b, eval = T, echo = T}
out_df2 <- compare_solutions_mplus(df, 
                                   dm_overall_eng, dm_challenge, dm_competence,
                                   starts = c(600, 120),
                                   n_processors = 8)
```

#### Following up on composite of engagement

```{r, echo = T}
m2_5b <- estimate_profiles_mplus(df, 
                        dm_overall_eng, dm_challenge, dm_competence,
                        starts = c(600, 120),
                        model = 2, n_profiles=5,
                        n_processors = 8)

m2_6b <- estimate_profiles_mplus(df, 
                        dm_overall_eng, dm_challenge, dm_competence,
                        starts = c(600, 120),
                        model = 2, n_profiles=6,
                        n_processors = 8)

m2_7b <- estimate_profiles_mplus(df, 
                        dm_overall_eng, dm_challenge, dm_competence,
                        starts = c(600, 120),
                        model = 2, n_profiles=7,
                        n_processors = 8)
...
```{r, echo = T}
m2_5b %>% plot_profiles_mplus()
m2_6b
m2_7b %>% plot_profiles_mplus()
```

## 3. Just engagement

```{r, 2c, eval = T, echo = T}
out_df3 <- compare_solutions_mplus(df, 
                                   dm_cog_eng, dm_beh_eng, dm_aff_eng,
                                   starts = c(600, 120),
                                   n_processors = 8)
```

#### Following up on just engagement

```{r, echo = T}
m2_4c <- estimate_profiles_mplus(df, 
                        dm_cog_eng, dm_beh_eng, dm_aff_eng,
                        starts = c(600, 120),
                        model = 2, n_profiles=5,
                        n_processors = 8)

m2_5c <- estimate_profiles_mplus(df, 
                        dm_cog_eng, dm_beh_eng, dm_aff_eng,
                        starts = c(600, 120),
                        model = 2, n_profiles=6,
                        n_processors = 8)

m2_6c <- estimate_profiles_mplus(df, 
                        dm_cog_eng, dm_beh_eng, dm_aff_eng,
                        starts = c(600, 120),
                        model = 2, n_profiles=7,
                        n_processors = 8)
...
```{r, echo = T}
m2_4c%>% plot_profiles_mplus()
m2_5c%>% plot_profiles_mplus()
m2_6c 
```