...
```{r, 2a}
m1 <- compare_models_mplus(df, dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence, model = 1:3, st_iterations=20, starts = c(100, 20))
```

```{r, 2b}
m2 <- compare_models_mplus(df, dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence, model = 1:3, st_iterations=20, starts = c(500, 100))

x <- create_profiles_mplus(df, dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence, model = 2, n_profiles = 3, st_iterations=20, starts = c(100, 20), remove_tmp_files=F)
```