...
estimate_profiles_mplus(df,
                        dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence, model = 4, n_profiles=3, remove_tmp_files=F, starts = c(500, 50), st_iterations = 50)
```

### 2C: All five variables w/ no prior w/ suggested settings

```{r, 2c, eval = F}
out_df3 <- compare_solutions_mplus(df, dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence, starts = c(500, 100), n_profiles_max=8, return_table=T)
```
...
m6i <- estimate_profiles_mplus(df,
                              dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence, model = 2, n_profiles=6, remove_tmp_files=F, starts = c(500, 50), n_processors=8)
m7i <- estimate_profiles_mplus(df,
                              dm_cog_eng, dm_beh_eng, dm_aff_eng, dm_challenge, dm_competence, model = 2, n_profiles=7, remove_tmp_files=F, starts = c(500, 50), n_processors=8)
