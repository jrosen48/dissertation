...
## Appendix A: STEM-PQA alignment table

This table presents the aspect of work with data with the corresponding STEM-PQA code(s).
...
names(t) <- c("Aspect of Work with Data", "x", "Corresponding STEM-PQA code(s)")
t <- t[, c(1, 3)]
