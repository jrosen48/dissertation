...
Note that these codes were unique to each signal to which youth responded (but were not unique to each youth, as youth in the same program were signaled at the same time). I discuss limitations to use of the STEM-PQA for work with data in the discussion. 
